...
#	for asteroid in get_node("Path2D").get_children():
##		asteroid = asteroid.get_child(0)
#		asteroid.position += Vector2(1,0)
#		asteroid.rotation += .5 * delta
#		print (asteroid.position, "   KKKKKKKK")
#
#
#func split_asteroids():
#	pass
#
#func detach(asteroid):
#	pass
#
#func set_pos_and_trajectory(asteroid):
##	print (asteroid.get_child(0).get_global_position())
#	#AsteroidPath0 -> Area2D -> Sprite & Collision
